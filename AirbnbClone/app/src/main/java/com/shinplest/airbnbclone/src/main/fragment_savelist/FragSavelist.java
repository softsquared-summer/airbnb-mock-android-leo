...
public class FragSavelist extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String[] roomPhotoUrlSet = {"https://t4.daumcdn.net/thumb/R720x0/?fname=http://t1.daumcdn.net/brunch/service/user/76Cz/image/LVlkZ5olVzCMIaEb7DqwmmE1Nxc.JPG", "https://t4.daumcdn.net/thumb/R720x0/?fname=http://t1.daumcdn.net/brunch/service/user/76Cz/image/LVlkZ5olVzCMIaEb7DqwmmE1Nxc.JPG"};
        String[] locationSet = {"한국", "신주쿠, Shinjuku City, 일본"};
        int[] roomsSet= {1,2};
