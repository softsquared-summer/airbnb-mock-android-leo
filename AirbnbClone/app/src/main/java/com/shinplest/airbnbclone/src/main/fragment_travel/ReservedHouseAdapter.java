...
public class ReservedHouseAdapter extends RecyclerView.Adapter<ReservedHouseAdapter.MyViewHolder> {
    private ArrayList<ReservedResponse.ReservationList> mReservationLists;
    private Context context;

    public ReservedHouseAdapter(ArrayList<ReservedResponse.ReservationList> mReservationLists, Context context) {
        this.mReservationLists = mReservationLists;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final ReservedResponse.ReservationList reservation = mReservationLists.get(position);
